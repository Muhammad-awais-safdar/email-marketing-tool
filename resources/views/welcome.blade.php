...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Primary Meta Tags -->
        <title>Omnichannel Marketing Tool | Email & WhatsApp Campaigns</title>
        <meta name="title" content="Omnichannel Marketing Tool | Email & WhatsApp Campaigns">
        ...
        <meta property="og:title" content="Omnichannel Marketing Tool | Email & WhatsApp Campaigns">
        ...
        <meta property="twitter:title" content="Omnichannel Marketing Tool | Email & WhatsApp Campaigns">
